...
/* 001 */ std::string	RplWelcome (std::string server, std::string nick, std::string network, std::string user, std::string host)
{ return (" :Welcome to the " + network + " Network, " + nick + "!" + user + "@" + host); }
...
/* 004 */ std::string	RplMyInfo (std::string server, std::string version, std::string u_modes, std::string c_modes, std::string supp_c_modes)
{ return (" " + server + " " + version + " " + u_modes + " " + c_modes + " " + supp_c_modes); }
...
/* 301 */ std::string	RplAway (std::string dest_nick, std::string away_msg) {
	return (" " + dest_nick + " :" + away_msg); }
/* 302 */
...
int main() {
	...
	irc::numericReply(311, 1, "server", "nick", 4, "nick", "user", "host", "real_name");
